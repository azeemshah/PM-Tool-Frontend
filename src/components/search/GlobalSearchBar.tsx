                      ...
                      <div className="flex-grow min-w-0">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          {result.status &&
                            (() => {
                              ...
                              return (
                                ...
                                >
                                  {StatusIcon && (
                                    <StatusIcon className="h-4 w-4 rounded-full text-inherit" />
                                  )}
                                  <span>
                                    {transformStatusEnum(result.status)}
                                  </span>
                                </Badge>
                              );
                            })()}
                          {result.priority && (
                            <Badge
                              variant={
                                getPriorityVariant(result.priority) as any
                              }
                            ...
                            >
                              {getPriorityIcon(result.priority) &&
                                React.createElement(
                                  ...
                                  {
                                    className:
                                      "h-4 w-4 rounded-full text-inherit",
                                  },
                                )}
                          ...
                          <Avatar className="h-8 w-8">
                            <AvatarImage
                              src={getProfileImageUrl(
                                result.assignedTo?.profilePicture,
                              )}
                            />
                            <AvatarFallback
                              style={{
